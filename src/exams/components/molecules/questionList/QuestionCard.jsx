            ...
            <>
              ...
              <div>
                <QuestionMarkMenu
                  ...
                  initialMarks={
                    questionData.bookmarks?.map((b) => b.type) || []
                  }
                />
              </div>
            </>
              ...
              <div>
                ...
                pathname === "/questions" ? (
                  ...
                  <Link to="/user/subscription">
                    <div className="flex items-center justify-center gap-2 p-2 text-base text-green-800 bg-green-200 rounded-sm dark:bg-green-900 dark:text-green-300">
                      <IoIosLock />
